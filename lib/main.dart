...
class _AppDrawer extends StatelessWidget {
  ...
  void _showLanguageSheet(BuildContext context) {
    // ÖNEMLİ:
    // BottomSheet'in builder içindeki `ctx` context'i overlay context'idir.
    // `TakNakApp.setLocale(...)` üst widget ağacında TakNakAppState'i aradığı için
    // bazen `ctx` ile bulamaz. O yüzden **outer context** (bu fonksiyonun context'i)
    // ile setLocale çağırıyoruz.
    final outer = context;
      ...
      builder: (sheetCtx) {
        Widget tile(String label, String code) {
          return ListTile(
            ...
            title: Text(label),
            onTap: () {
              TakNakApp.setLocale(outer, Locale(code));
